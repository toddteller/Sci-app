...
class Level7: SKScene,SKPhysicsContactDelegate {
    ...
    let cameraNode = SKCameraNode() //Camera
       ...
       override func didMove(to view: SKView) {
          ...
          shape3.alpha = 0
           ...
           run(SKAction.repeatForever(SKAction.sequence([SKAction.run{
               [weak self] in self?.spawnMeteor()},SKAction.wait(forDuration: 4.0)])))
       ...
       func create_Bg() -> SKSpriteNode { //Create a unique bg formed by two parts
           let l1_bg1 = SKSpriteNode(imageNamed: "7-planet-background1") //Part one
           ...
           //------------------------------------------------------------------------------------------//
           let l1_bg2 = SKSpriteNode(imageNamed: "7-planet-background2") // Part two
       ...
       func createFullAstronaut() -> SKAction{
        ...
        func roll() -> SKAction{
            ...
            var rolltime = SKAction.rotate(toAngle: 1080, duration: 1.2)
       ...
       func spawnRock()  {
           if(numb>0 && numb_score<20) {
                  ...
                  let rock : SKSpriteNode = SKSpriteNode (imageNamed: "7-planet-ice\(random)")
                  rock.size = CGSize(width: 92, height: 111)
                  rock.position = CGPoint(x:cameraNode.position.x+500,y:55)
                  rock.zPosition = 2
      ...
      run(SKAction.sequence([SKAction.wait(forDuration: 1.5),actions]))
       ...
       func spawnCollectibles(){
           if(numb>0 && numb_score<20) {
               ...
               let collectible : SKSpriteNode = SKSpriteNode(imageNamed: "money7-1")
       ...
       func score(numb_score: String) {
           ...
           label.text = "Score : \(numb_score)/20"
           label.fontSize = 40
           label.zPosition = 3
       ...
       func createFullCoin() -> SKAction {
           ...
           for i in 1...4{
               coin_texture.append(SKTexture(imageNamed: "money7-\(i)"))
           }
