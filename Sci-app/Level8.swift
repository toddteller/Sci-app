    ...
    let cameraNode = SKCameraNode() //Camera
       ...
       override func didMove(to view: SKView) {
          ...
          shape3.alpha = 0
           ...
           run(SKAction.repeatForever(SKAction.sequence([SKAction.run{
               [weak self] in self?.spawnMeteor()},SKAction.wait(forDuration: 8.0)])))
       ...
       func create_Bg() -> SKSpriteNode { //Create a unique bg formed by two parts
           let l1_bg1 = SKSpriteNode(imageNamed: "8-planet-background1") //Part one
           ...
           //------------------------------------------------------------------------------------------//
           let l1_bg2 = SKSpriteNode(imageNamed: "8-planet-background2") // Part two
       ...
       func spawnRock()  {
           if(numb>0 && numb_score<30) {
                  ...
                  let rock : SKSpriteNode = SKSpriteNode (imageNamed: "8-planet-ice\(random)")
       ...
       func setAstro(){
        ...
        run(SKAction.sequence([SKAction.wait(forDuration: 3.0),actions]))
       ...
       func score(numb_score: String) {
           ...
           label.text = "Score : \(numb_score)/30"
           label.fontSize = 40
           label.zPosition = 3
