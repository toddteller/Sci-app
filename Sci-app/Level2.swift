    ...
    let cameraNode = SKCameraNode() //Camera
       ...
       override func didMove(to view: SKView) {
          ...
          shape3.alpha = 0
           ...
           },SKAction.wait(forDuration: 5.0),SKAction.run{
               [weak self] in self?.setAstro()}])))
           
           run(SKAction.repeatForever(SKAction.sequence([SKAction.run{
               [weak self] in self?.spawnMeteor()},SKAction.wait(forDuration: 7.0)])))
       ...
       func create_Bg() -> SKSpriteNode { //Create a unique bg formed by two parts
           let l1_bg1 = SKSpriteNode(imageNamed: "2-planet-background1") //Part one
           ...
           //------------------------------------------------------------------------------------------//
           let l1_bg2 = SKSpriteNode(imageNamed: "2-planet-background2") // Part two
       ...
       func createFullAstronaut() -> SKAction{
        ...
        func roll() -> SKAction{
            ...
            let astro_animation = SKAction.group([SKAction.animate(with: astro_texture, timePerFrame: 2.5),rolltime])
       ...
       func spawnRock()  {
           if(numb>0 && numb_score<5) {
                  ...
                  let rock : SKSpriteNode = SKSpriteNode (imageNamed: "2-planet-rocks\(random)")
       ...
       func spawnCollectibles(){
           if(numb>0 && numb_score<5) {
               ...
               let collectible : SKSpriteNode = SKSpriteNode(imageNamed: "money2-1")
       ...
       func createFullCoin() -> SKAction {
           ...
           for i in 1...4{
               coin_texture.append(SKTexture(imageNamed: "money2-\(i)"))
           }
