...
class Level4: SKScene,SKPhysicsContactDelegate {
    ...
    let cameraNode = SKCameraNode() //Camera
       ...
       func create_Bg() -> SKSpriteNode { //Create a unique bg formed by two parts
           let l1_bg1 = SKSpriteNode(imageNamed: "4-planet-background1") //Part one
           ...
           //------------------------------------------------------------------------------------------//
           let l1_bg2 = SKSpriteNode(imageNamed: "4-planet-background2") // Part two
       ...
       func spawnRock()  {
           if(numb>0 && numb_score<15) {
                  ...
                  let rock : SKSpriteNode = SKSpriteNode (imageNamed: "4-planet-rocks\(random)")
       ...
       func spawnCollectibles(){
           if(numb>0 && numb_score<15) {
               ...
               let collectible : SKSpriteNode = SKSpriteNode(imageNamed: "money4-1")
       ...
       func score(numb_score: String) {
           ...
           label.text = "Score : \(numb_score)/15"
           label.fontSize = 40
           label.zPosition = 3
       ...
       func createFullCoin() -> SKAction {
           ...
           for i in 1...4{
               coin_texture.append(SKTexture(imageNamed: "money4-\(i)"))
           }
