...
class Level5: SKScene,SKPhysicsContactDelegate {
    ...
    let cameraNode = SKCameraNode() //Camera
       ...
       func create_Bg() -> SKSpriteNode { //Create a unique bg formed by two parts
           let l1_bg1 = SKSpriteNode(imageNamed: "5-planet-background1") //Part one
           ...
           //------------------------------------------------------------------------------------------//
           let l1_bg2 = SKSpriteNode(imageNamed: "5-planet-background2") // Part two
       ...
       func spawnRock()  {
           if(numb>0 && numb_score<15) {
                  ...
                  let rock : SKSpriteNode = SKSpriteNode (imageNamed: "5-planet-gas\(random)")
                  rock.size = CGSize(width: 175, height: 83)
                  rock.position = CGPoint(x:cameraNode.position.x+500,y:45)
                  rock.zPosition = 2
       ...
       func spawnCollectibles(){
           if(numb>0 && numb_score<15) {
               ...
               let collectible : SKSpriteNode = SKSpriteNode(imageNamed: "money5-1")
       ...
       func createFullCoin() -> SKAction {
           ...
           for i in 1...4{
               coin_texture.append(SKTexture(imageNamed: "money5-\(i)"))
           }
