...
class Level6: SKScene,SKPhysicsContactDelegate {
    ...
    let cameraNode = SKCameraNode() //Camera
       ...
       func create_Bg() -> SKSpriteNode { //Create a unique bg formed by two parts
           let l1_bg1 = SKSpriteNode(imageNamed: "6-planet-background1") //Part one
           ...
           //------------------------------------------------------------------------------------------//
           let l1_bg2 = SKSpriteNode(imageNamed: "6-planet-background2") // Part two
       ...
       func spawnRock()  {
           if(numb>0 && numb_score<18) {
                  ...
                  let rock : SKSpriteNode = SKSpriteNode (imageNamed: "6-planet-gas\(random)")
       ...
       func spawnCollectibles(){
           if(numb>0 && numb_score<18) {
               ...
               let collectible : SKSpriteNode = SKSpriteNode(imageNamed: "money6-1")
       ...
       func score(numb_score: String) {
           ...
           label.text = "Score : \(numb_score)/18"
           label.fontSize = 40
           label.zPosition = 3
       ...
       func createFullCoin() -> SKAction {
           ...
           for i in 1...4{
               coin_texture.append(SKTexture(imageNamed: "money6-\(i)"))
           }
