...
//  Game_1
//
//  Created by Aiello Giovanni on 18/11/2019.
//  Copyright © 2019 Aiello Giovanni. All rights reserved.
//
...
import AVFoundation
    ...
    var  astro_value : UInt32 = 1
    var rock_value: UInt32 = 2
...
class Level1: SKScene,SKPhysicsContactDelegate{
    ...
    func create_Bg() -> SKSpriteNode { //Create a unique bg formed by two parts
        let l1_bg1 = SKSpriteNode(imageNamed: "1-planet-background1") //Part one
        ...
        //------------------------------------------------------------------------------------------//
        let l1_bg2 = SKSpriteNode(imageNamed: "1-planet-background2") // Part two
    ...
    func createFullAstronaut() -> SKAction{
     ...
     func roll() -> SKAction{
         ...
         var rolltime = SKAction.rotate(toAngle: 1080, duration: 1.5)
        ...
        if (numb>0 && numb_score<5) {
            if( touches.count == 1) {
                   if  astro.position.y<200{
                    ...
                    let down = SKAction.moveTo(y: astro.position.y, duration: 1.0)
    ...
    func spawnRock()  {
        if(numb>0 && numb_score<5) {
               ...
               let rock : SKSpriteNode = SKSpriteNode (imageNamed: "1-planet-rocks\(random)")
    ...
    func spawnCollectibles(){
        if(numb>0 && numb_score<5) {
            ...
            let collectible : SKSpriteNode = SKSpriteNode(imageNamed: "money1-1")
    ...
    func createFullCoin() -> SKAction {
        ...
        for i in 1...4{
            coin_texture.append(SKTexture(imageNamed: "money1-\(i)"))
        }
